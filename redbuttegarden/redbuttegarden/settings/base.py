...
# Intranet CDC roster sync
INTRANET_ACTIVE_CDC_MEMBERS_URL = os.environ.get("INTRANET_ACTIVE_CDC_MEMBERS_URL")
INTRANET_ACTIVE_CDC_MEMBERS_TOKEN = os.environ.get("INTRANET_ACTIVE_CDC_MEMBERS_TOKEN")
INTRANET_ACTIVE_CDC_MEMBERS_TIMEOUT = int(
    os.environ.get("INTRANET_ACTIVE_CDC_MEMBERS_TIMEOUT", "10")
)
INTRANET_ACTIVE_CDC_MEMBERS_ALLOW_EMPTY_SNAPSHOT = (
    os.environ.get("INTRANET_ACTIVE_CDC_MEMBERS_ALLOW_EMPTY_SNAPSHOT", "").lower()
    in {"1", "true", "yes"}
)
