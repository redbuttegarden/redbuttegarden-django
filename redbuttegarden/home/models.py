...
class GeneralPage(AbstractBase):
    body = StreamField(block_types=[
        ...
        ('html', blocks.RawHTMLBlock()),
        ('image_list_dropdown_info', ImageListDropdownInfo()),
        ('button_list_dropdown_info', ButtonListDropdownInfo()),
        ('card_list_dropdown_info', CardListDropdownInfo()),
        ('image_list_card_info', ImageListCardInfo()),
