...
class TestRetailPartnerPage(WagtailPageTests):
    ...
    def test_retail_partner_with_three_retail_partners(self):
        ...
        self.assertIn('<div class="row g-4 text-center tan-bg">', html)
        self.assertNotIn('<div class="row g-4 text-center bg-white">', html)
    ...
    def test_retail_partner_with_four_retail_partners(self):
        ...
        self.assertContains(
            response,
            """<div class="row g-4 text-center bg-white">\n          \n            <div class="col-12 col-md-6 col-lg-4">\n              <div class="h-100 p-3">\n                \n                  \n\n<h3 class="green">Fourth Test Partner</h3>\n\n\n    <div class="fs-6 fw-bold mb-2">\n  123 Test Lane, Test City\n  , 12345\n  <a href="tel:(123) 123-1234">(123) 123-1234</a>\n</div>\n\n\n\n<p><a href="https://example.com">https://example.com</a></p>\n\n<p>Testing!</p>\n\n                \n              </div>\n            </div>\n          \n            <div class="col-12 col-md-6 col-lg-4">\n              <div class="h-100 p-3">\n                \n                  <p class="green fs-3 fw-bold mb-0">Your business could be here!</p>\n                \n              </div>\n            </div>\n          \n            <div class="col-12 col-md-6 col-lg-4">\n              <div class="h-100 p-3">\n                \n                  <p class="green fs-3 fw-bold mb-0">Your business could be here!</p>\n                \n              </div>\n            </div>\n          \n        </div>""",
            count=1,
            html=True,
        )
