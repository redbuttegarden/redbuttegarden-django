...
def get_collection(
    latitude=40,
    longitude=-111,  # Location
    area="Butterfly Walk",
    ga_name="Children's Garden",
    code="CG-06",  # GardenArea
    ...
    subforma=None,
    cultivar="Allgold",
    vernacular_name="Allgold Warminster Broom",
    habit="Deciduous Shrub",
    hardiness=None,
    water_regime="Low",
    exposure="Full Sun to Part Shade",
    bloom_time=None,
    plant_size="5' h x 5' w",
    flower_color="Yellow",
    utah_native=False,
    plant_select=False,
    deer_resist=True,
    ...
    plant_date="2000-5-1",
    plant_id="2000-1024*1",
    commemoration_category=None,
    ...
    species = get_species(
        ...
        utah_native=utah_native,
        plant_select=plant_select,
        deer_resist=deer_resist,
        rabbit_resist=rabbit_resist,
        bee_friend=bee_friend,
    ...
    return Collection.objects.create(
        ...
        plant_id=plant_id,
        commemoration_category=commemoration_category,
