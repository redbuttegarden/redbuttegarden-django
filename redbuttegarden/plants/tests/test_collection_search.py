...
class PlantSearchViewTestCase(TestCase):
    def _get_geojson(self, params: dict):
        url = reverse("plants:api-collections-geojson")
        if params:
    ...
    def test_collection_search_by_scientific_name(self):
        ...
        get_collection(
            ...
            family_name="1",
            genus_name="Geranium",
            full_name="Geranium 'Johnson's Blue'",
        ...
        get_collection(
            ...
            family_name="3",
            genus_name="Cytisus",
            species_name="praecox",
            full_name="Cytisus × praecox 'Allgold'",
        )
        get_collection(
            plant_id="4",
            family_name="Rosaceae",
            genus_name="Crataegus",
            species_name="crus-galli",
            variety="inermis",
        ...
        json_response = self._get_geojson({"scientific_name": "Geranium"})
        self.assertEqual(len(json_response["features"]), 1)
        self.assertEqual(
            json_response["features"][0]["properties"]["species_full_name"],
            "Geranium 'Johnson's Blue'",
        )

        json_response = self._get_geojson({"scientific_name": "Allgold"})
        self.assertEqual(len(json_response["features"]), 1)
        self.assertEqual(
            json_response["features"][0]["properties"]["species_full_name"],
        ...
        json_response = self._get_geojson({"scientific_name": "inermis"})
        ...
        json_response = self._get_geojson({"scientific_name": "subsp. petiolaris"})
        self.assertEqual(len(json_response["features"]), 1)
        self.assertEqual(
            json_response["features"][0]["properties"]["species_full_name"],
        ...
        json_response = self._get_geojson({"scientific_name": "Acer rubrum"})
        self.assertEqual(len(json_response["features"]), 1)
        self.assertEqual(
            json_response["features"][0]["properties"]["species_full_name"],
    ...
    def test_collection_search_by_garden_area(self):
        ...
        json_response = self._get_geojson({"garden_name": "Garden One"})
        self.assertEqual(len(json_response["features"]), 1)
        self.assertEqual(
            json_response["features"][0]["properties"]["garden_name"], "Garden One"
        )
        ...
        self.assertEqual(
            json_response["features"][1]["properties"]["garden_name"], "Garden One"
        )
    ...
    def test_collection_search_by_bloom_time(self):
        ...
        get_collection(
            plant_id="6",
            bloom_time=["Late March", "Early April", "May"],
            latitude=45,
            longitude=-116,
            family_name="6",
            genus_name="6",
        ...
        json_response = self._get_geojson({"bloom_months": "January"})
        self.assertEqual(len(json_response["features"]), 3)
        self.assertEqual(
            json_response["features"][0]["properties"]["bloom_time"], ["Late January"]
        )
        self.assertEqual(
            json_response["features"][1]["properties"]["bloom_time"], ["Early January"]
        )
        self.assertEqual(
            json_response["features"][2]["properties"]["bloom_time"], ["January"]
        )

        json_response = self._get_geojson({"bloom_months": "April"})
        self.assertEqual(len(json_response["features"]), 2)
        self.assertEqual(
            json_response["features"][0]["properties"]["bloom_time"],
            ["Late March", "Early April", "May"],
        )
        self.assertEqual(
            json_response["features"][1]["properties"]["bloom_time"],
            ["March", "Mid April"],
        )

    def test_collection_search_by_flower_color(self):
        get_collection(
            plant_id="1", family_name="1", genus_name="1", flower_color="Purple, Blue"
        )
        get_collection(
            plant_id="2", family_name="2", genus_name="2", flower_color="Purple, Red"
        )

        json_response = self._get_geojson({"flower_colors": "Purple"})
        self.assertEqual(len(json_response["features"]), 2)
        feature_one_id = json_response["features"][0]["properties"]["id"]
        feature_two_id = json_response["features"][1]["properties"]["id"]
        self.assertEqual(
            Collection.objects.get(id=feature_one_id).species.flower_color,
            "Purple, Red",
        )
        self.assertEqual(
            Collection.objects.get(id=feature_two_id).species.flower_color,
            "Purple, Blue",
        )
    ...
    def test_collection_search_by_scientific_name_and_vernacular_name(self):
        get_collection(
            ...
            species_name="rubrum",
            cultivar="Red Lake",
            full_name="Ribes rubrum 'Red Lake'",
            vernacular_name="Red Lake Currant",
        )
        get_collection(
            plant_id="2",
            family_name="Grossulariaceae",
        ...
        get_collection(
            ...
            genus_name="Pinus",
            species_name="resinosa",
            cultivar="Don Smith",
            full_name="Pinus resinosa 'Don Smith'",
            vernacular_name="Don Smith Red Pine",
        )

        json_response = self._get_geojson(
            {"scientific_name": "Ribes rubrum", "common_name": "Red"}
        )
        self.assertEqual(len(json_response["features"]), 2)
        self.assertEqual(
            json_response["features"][0]["properties"]["species_full_name"],
        ...
        self.assertEqual(
            json_response["features"][1]["properties"]["species_full_name"],
            "Ribes rubrum 'Red Lake'",
        )
    ...
    def test_collection_search_by_commemoration_person(self):
        ...
        json_response = self._get_geojson({"memorial_person": "Test Name"})
        self.assertEqual(len(json_response["features"]), 1)
